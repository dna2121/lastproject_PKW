...
<html lang="en">
    ...
    <body >
        ...
        <div class="container data-mahasiswa mt-5">
            ...
            <button style="background-color: #61C0BF;" type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#tambahData">
                Tambah Data
            </button>
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <td>
                            ...
                            <!-- edit.php?id=<........-->
                            <a style="background-color: #F67280;" href="edit.php?id=<?php echo $data['id']; ?>" class="btn btn-sm text-white">EDIT</a>
                            <!-- link untuk delete berdasarkan id, akan keluar confirm terlebih dahulu-->
                            <a style="background-color: #C06C84;" href="delete.php?id=<?php echo $data['id']; ?>" class="btn btn-sm text-white" onclick="return confirm('Anda yakin akan menghapus data buku ini?')">HAPUS</a>
                            <a style="background-color: #6C5B7B;" href="print.php?id=<?php echo $data['id']; ?>" class="btn btn-sm text-white">CETAK</a>
                        </td>
                    </tr>
                <?php
                }
